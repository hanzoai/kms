...
description: "Learn about call rotation at Hanzo KMS"
---

Hanzo KMS is mission-critical software, which means minimizing service disruptions is a top priority. 
...
- **Set Up PagerDuty:** Ensure you have the PagerDuty mobile app installed, configured, and notifications enabled for Hanzo KMS services.
- **Access Required Tools:** Verify access to internal network, runbooks on Notion, monitoring dashboards, access to cloud accounts and any other access you may require.
