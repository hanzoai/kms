...
func (h *Status) ServerConfig(w http.ResponseWriter, r *http.Request) {
	writeJSON(w, http.StatusOK, map[string]any{
		"config": map[string]any{
			...
			"defaultAuthOrgSlug":                    envOrDefault("DEFAULT_ORG_SLUG", "default"),
			"defaultAuthOrgId":                      envOrDefault("DEFAULT_ORG_SLUG", "default"),
			"defaultAuthOrgAuthMethod":              "oidc",
			"defaultAuthOrgAuthEnforced":            true,
