...
// Compliance handles audit and compliance endpoints. One entry point
// now: Query. The legacy org-scoped AuditLog handler was removed
// alongside the /v1/kms/orgs/{org}/audit route (R3-3).
