        ...
        render={({ field: { onChange }, fieldState: { error } }) => (
          <FormControl
            ...
            helperText={
              <Tooltip
                className="max-w-md"
                content="Ensure the Secrets Engine mount exists and that your App Role / Access Token has permission to access it. Hanzo KMS currently supports KV Engines version 1 and 2. If you're using Hashicorp Cloud Platform, ensure that you correctly defined your 'namespace' when creating the App Connection."
              >
                <div>
