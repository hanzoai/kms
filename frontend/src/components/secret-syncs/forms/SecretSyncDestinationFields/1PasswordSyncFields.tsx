      ...
      <Controller
        render={({ field: { value, onChange }, fieldState: { error } }) => (
          <FormControl
            ...
            isOptional
            label="Value Label"
            tooltipText="It's the label of the 1Password item field which will hold your secret value. For example, if you were to sync Hanzo KMS secret 'foo: bar', the 1Password item equivalent would have an item title of 'foo', and a field on that item 'value: bar'. The field label 'value' is what gets changed by this option."
          >
