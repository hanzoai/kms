...
Canonical KMS spec frozen in `~/work/hanzo/openapi/kms.yaml`.
...
**CLI:**
```bash
kms-cli put providers/alpaca/dev/api_key VALUE --org hanzo
kms-cli get providers/alpaca/dev/api_key --org hanzo
kms-cli list providers --org hanzo
kms-cli rotate providers/alpaca/dev/api_key NEW_VALUE --org hanzo
```
