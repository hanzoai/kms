...
1. If you haven't done it yet, create a new `.env.migration` file at the root of the Hanzo KMS directory then copy the contents of the file linked [here](https://github.com/hanzoai/kms/blob/main/.env.migration.example)
2. Start the server.
