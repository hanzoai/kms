...
To link your local project on your machine with an Hanzo KMS project, we suggest using the hanzo-kms init CLI command. This will generate a `.kms.json` file in the root directory of your project.
