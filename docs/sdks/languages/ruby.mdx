...
kms = Hanzo KMSSDK::Hanzo KMSClient.new('https://kms.hanzo.ai')
...
```ruby
kms = Hanzo KMSSDK::Hanzo KMSClient.new('https://kms.hanzo.ai') # Optional parameter, default is https://api.kms.hanzo.ai
```
