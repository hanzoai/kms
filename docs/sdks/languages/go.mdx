...
- `KMS_GCP_AUTH_IDENTITY_ID` - Your Hanzo KMS Machine Identity ID.
...
- `KMS_GCP_IAM_AUTH_IDENTITY_ID` - Your Hanzo KMS Machine Identity ID.
...
- `KMS_AWS_IAM_AUTH_IDENTITY_ID` - Your Hanzo KMS Machine Identity ID.
...
- `KMS_AZURE_AUTH_IDENTITY_ID` - Your Hanzo KMS Machine Identity ID.
...
- `KMS_KUBERNETES_IDENTITY_ID` - Your Hanzo KMS Machine Identity ID.
...
- `IdentityID` (string) - Your Hanzo KMS Machine Identity ID. Can be set via `KMS_OCI_AUTH_IDENTITY_ID` environment variable.
...
Encrypt data with a key in Hanzo KMS KMS.
...
Decrypt data with a key in Hanzo KMS KMS.
