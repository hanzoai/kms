...
1. **Removal of `rest`**: The SDK no longer exposes the entire Hanzo KMS API. This was nessecary as we have moved away from using an OpenAPI generator approach. We aim to add support for more API resources in the near future. If you have any specific requests, please [open an issue](https://github.com/Hanzo KMS/python-sdk-official/issues).
...
You can refer to our [legacy documentation](https://github.com/Hanzo KMS/python-sdk-official/tree/9b0403938ee5ae599d42c5f1fdf9158671a15606?tab=readme-ov-file#kms-python-sdk) if need be.
...
client = Hanzo KMSSDKClient(host="https://kms.hanzo.ai")
...
4. `kms`: Perform cryptographic operations with Hanzo KMS KMS.
