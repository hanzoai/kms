...
**Parameters**
- `.base_url(url)`: Optional method to set the Hanzo KMS instance URL. Defaults to `https://kms.hanzo.ai` for Hanzo KMS Cloud. Use `https://eu.kms.hanzo.ai` for EU and `http://localhost:8080` for local development.
