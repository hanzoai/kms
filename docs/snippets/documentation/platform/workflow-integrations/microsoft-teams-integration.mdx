    ...
    <Steps>
      <Step title="Install the Hanzo KMS Microsoft Teams App in Microsoft Teams tenant">

        Currently, Hanzo KMS requires you to install a custom Microsoft Teams app into your Microsoft Teams tenant.

        You can download the Hanzo KMS Microsoft Teams app package here:
        - [Hanzo KMS Microsoft Teams app package](https://kms-microsoft-teams-app.s3.us-east-1.amazonaws.com/Hanzo KMS.zip)

        <Note>
          **Important for self-hosted users:**

          If you're self-hosting Hanzo KMS, you can skip the download step. Instead you should use the app package file you downloaded from the Microsoft Teams Developer Portal when you followed the Self-hosted guide.
        </Note>
        ...
        <Warning>
          After the app has been approved, it can take a few hours _(up to 24 hours in some cases)_ for Microsoft Teams to reflect the new app. During this period, the Hanzo KMS app will not be visible in Microsoft Teams, and won't be usable.
        </Warning>

        Once the app has been approved, you will be able to use the Hanzo KMS Microsoft Teams integration in your projects.
      </Step>

      <Step title="Add the Hanzo KMS Microsoft Teams app to your Microsoft Teams teams">
        ...
        Navigate to **Apps** > **Built for your org**, select the "Hanzo KMS" app, and press the "Add" button to select the teams and channels you wish to add the app to.
        ...
        Once the app has been added to the team, you will be able to use the Hanzo KMS Microsoft Teams integration in the team.
      </Step>

      <Step title="Navigate to the Workflow Integrations tab in your organization settings">

        After installing the Microsoft Teams app, you are now ready to configure the Microsoft Teams integration within Hanzo KMS.
      ...
      <Step title="Create a Microsoft Teams workflow integration">
        In order to use the Hanzo KMS Microsoft Teams integration, you will need to grant admin consent to the app. Once the consent is granted, the Microsoft Teams workflow integration will be created in your Hanzo KMS organization.
        ...
        The tenant ID is the ID of the Microsoft 365 / Azure AD tenant that you installed the Hanzo KMS Microsoft Teams app in, in the previous steps.
        ...
        Once you've granted admin consent, you'll be navigated back to the Hanzo KMS organization settings, where you can now select the Microsoft Teams integration you just created.
