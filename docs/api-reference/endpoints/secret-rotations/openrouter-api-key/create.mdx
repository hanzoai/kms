...
Creates an OpenRouter API Key secret rotation. Hanzo KMS will create and rotate API keys via your [OpenRouter connection](/integrations/app-connections/openrouter) and write them to the specified secret path.
