...
To eliminate the need for static credentials, you can authenticate your workflow using [OpenID Connect (OIDC)](https://kms.hanzo.ai/docs/documentation/platform/identities/oidc-auth/general) through providers like the [Hanzo KMS Secrets GitHub Action](https://github.com/Hanzo KMS/secrets-action).
