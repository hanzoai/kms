---
title: "DNS Made Easy"
description: "Learn how to configure a DNS Made Easy Connection for Hanzo KMS."
---

Hanzo KMS supports connecting to DNS Made Easy using API key and secret key for secure access to your DNS Made Easy service.

## Configure API key and secret Key for Hanzo KMS
...
## Setup DNS Made Easy Connection in Hanzo KMS
...
<Steps>
  ...
  <Step title="Connection Created">
    Your **DNS Made Easy Connection** is now available for use in your Hanzo KMS
