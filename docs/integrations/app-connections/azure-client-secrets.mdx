...
description: "Learn how to configure an Azure Client Secrets Connection for Hanzo KMS."
---

Hanzo KMS currently only supports two methods for connecting to Azure, which are OAuth and Client Secrets.

<Accordion title="Self-Hosted Instance">
  Using the Azure Client Secrets connection on a self-hosted instance of Hanzo KMS requires configuring an application in Azure
