...
description: "Learn how to configure a Render Connection for Hanzo KMS."
---

Hanzo KMS supports connecting to Render using API keys for secure access to your Render services.

## Configure API Key for Hanzo KMS
...
## Setup Render Connection in Hanzo KMS
...
<Steps>
  ...
  <Step title="Connection Created">
    Your **Render Connection** is now available for use in your Hanzo KMS
