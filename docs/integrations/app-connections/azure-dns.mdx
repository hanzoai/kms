...
description: "Learn how to configure an Azure DNS Connection for KMS."
---

KMS supports connecting to Azure DNS using a Service Principal with Client Secrets for secure access to manage DNS records in your Azure DNS zones.
...
## Setup Azure DNS Connection in KMS
...
<Steps>
  ...
  <Step title="Connection Created">
    Your **Azure DNS Connection** is now available for use in your KMS projects.
