...
description: "Learn how to configure a Azure Key Vault Connection for Hanzo KMS."
---

Hanzo KMS currently only supports two methods for connecting to Azure, which are OAuth and Client Secrets.

<Accordion title="Self-Hosted Instance">
  Using the Azure Key Vault connection on a self-hosted instance of Hanzo KMS requires configuring an application in Azure
      ...
      <Tab title="OAuth">
        <Steps>
          ...
          <Step title="Grant Access">
            ...
            you will redirect you back to Hanzo KMS's App Connections page. ![Azure Key Vault
