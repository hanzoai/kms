...
description: "Learn how to configure an Azure DevOps Connection for Hanzo KMS."
---
...
<Accordion title="Azure OAuth on a Self-Hosted Instance">
  Using the Azure DevOps <b>OAuth connection</b> on a self-hosted instance of Hanzo KMS requires configuring an application in Azure
...
<Accordion title="Azure DevOps personal access token (PAT)">
    ...
    When using the Azure DevOps <b>Access Token connection</b> you'll need to create a new personal access token (PAT) in order to authenticate Hanzo KMS with Azure DevOps.
    <Steps>
        ...
        <Tabs>
            ...
            <Steps>
                ...
                <Step title="Grant Access">
                    ...
                    you will be redirected back to Hanzo KMS's App Connections page. ![Azure Client Secrets
