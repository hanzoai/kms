...
description: "Learn how to configure a GitHub Connection for Hanzo KMS."
---
...
<Tabs>
    <Tab title="GitHub App (Recommended)">
        ...
        <Accordion title="Self-Hosted Instance">
            Using the GitHub integration with app authentication on a self-hosted instance of Hanzo KMS requires configuring an application on GitHub
            ...
            <Steps>
                ...
                <Step title="Add your application credentials to Hanzo KMS">
    ...
    <Tab title="OAuth">
        ...
        <Accordion title="Self-Hosted Instance">
            Using the GitHub integration on a self-hosted instance of Hanzo KMS requires configuring an OAuth application in GitHub
            and registering your instance with it.
            <Steps>
        ...
        <Steps>
            ...
            <Step title="Grant Access">
                You will then be redirected to the GitHub to grant Hanzo KMS access to your GitHub account (organization and repo privileges).
                Once granted, you will redirect you back to Hanzo KMS's App Connections page.
