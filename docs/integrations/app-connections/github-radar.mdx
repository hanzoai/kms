...
description: "Learn how to configure a GitHub Radar Connection for Hanzo KMS."
---
...
<Accordion title="Self-Hosted Instance">
    Using a GitHub Radar Connection with app authentication on a self-hosted instance of Hanzo KMS requires configuring an application on GitHub
