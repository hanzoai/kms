...
description: "Learn how to configure a Heroku Connection for Hanzo KMS using OAuth or Auth Token methods."
---
    ...
    <Accordion title="Self-Hosted Instance Setup">
      ...
      **Prerequisites:**
      ...
      <Steps>
        ...
        <Step title="Add your Heroku API client credentials to Hanzo KMS">
