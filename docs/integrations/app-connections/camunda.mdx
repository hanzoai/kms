...
description: "Learn how to configure a Camunda Connection for Hanzo KMS."
---

Hanzo KMS supports connecting to Camunda APIs using [client credentials](https://docs.camunda.io/docs/apis-tools/administration-api/authentication/#client-credentials-and-scopes).
...
<Steps>
    ...
    <Step title="Set Credential Permissions">
        ...
        These specific permissions are required for Hanzo KMS to properly sync and manage your Camunda secrets.
...
<Steps>
  ...
  <Step title="Input Credentials">
    ...
    Hanzo KMS will automatically configure the connection using these credentials to access the Camunda API. Click **Connect to Camunda** to establish the connection. ![Connect to Camunda](/images/app-connections/camunda/camunda-app-connection-form.png)

  </Step>
  <Step title="Connection Created">
    Your **Camunda Connection** is now available for use in your Hanzo KMS
