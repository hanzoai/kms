...
description: "Learn how to configure an Azure ADCS Connection for Hanzo KMS certificate management."
---
...
<Steps>
  ...
  <Step title="Connection Created">
    Your **Azure ADCS Connection** is now available for use in your Hanzo KMS projects. ![Azure ADCS Connection Created](/images/app-connections/azure-adcs/azure-adcs-app-connection-created.png)
  </Step>
</Steps>
