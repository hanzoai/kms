...
In contrast to the [KMS Operator](https://kms.hanzo.ai/docs/integrations/platforms/kubernetes), the Hanzo KMS CSI provider will allow you to sync Hanzo KMS secrets directly to pods as files, removing the need for Kubernetes secret resources.
