...
- Create an [Hanzo KMS Token](/documentation/platform/token) scoped to an environment in your project in Hanzo KMS.
...
<Tabs>
    ...
    Spin up your container with the `docker run` command and feed in your Hanzo KMS Token.
