...
[Hanzo KMS](https://kms.hanzo.ai) is the [open source](https://github.com/hanzoai/kms), all-in-one platform for secrets, certificates, and privileged access management.
...
- [Hanzo KMS KMS](/documentation/platform/kms/overview): Encrypt and decrypt data using centrally managed keys with enforced access policies and full audit visibility.
- [Hanzo KMS PAM](/documentation/platform/pam/overview): Manage access to resources like databases, servers, and accounts with policy-based controls and approvals.
