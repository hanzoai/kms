...
description: "Understand how organizations and projects are structured in Hanzo KMS."
---

Hanzo KMS is structured around organizations and projects, allowing teams to manage multiple products, access scopes, and use cases within a single account while keeping boundaries and responsibilities clearly defined.
...
Teams can adopt Hanzo KMS incrementally—starting with one product and expanding as needed.
