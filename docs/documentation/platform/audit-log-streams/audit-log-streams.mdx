...
<Info>
    ...
    If you're using Hanzo KMS Cloud, then it is available under the **Enterprise Tier**. If you're self-hosting Hanzo KMS, then you should contact team@kms.hanzo.ai to purchase an enterprise license to use it.
</Info>
