...
description: "Learn how to issue and manage certificates using AWS Private Certificate Authority (PCA) with KMS."
---
...
- An [AWS App Connection](/integrations/app-connections/aws) configured in KMS with the required IAM permissions (see below)
...
<Steps>
  ...
  <Step title="Navigate to External Certificate Authorities">
    In your KMS project, go to **Certificate Authorities** and scroll to the **External Certificate Authorities** section.
...
- AWS PCA must be in the **ACTIVE** state before KMS can issue certificates. Verify the status in the AWS Console under **AWS Private CA**.
