...
If your use case involves fully automated certificate management for workloads (e.g., using [KMS Agent](/documentation/platform/pki/guides/request-cert-agent)), you may want to enable the machine identity bypass option instead of requiring approval.
