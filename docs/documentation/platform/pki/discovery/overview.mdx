...
description: "Learn how to discover certificates across your infrastructure with KMS"
---
...
KMS supports multiple discovery types, each targeting a different source of certificates:
...
<AccordionGroup>
  <Accordion title="How are discovered certificates matched to existing certificates?">
    Discovered certificates are matched by their fingerprint. If a discovered certificate matches an existing certificate in your KMS project, the installation will be linked to that certificate.
  </Accordion>
