...
<Steps>
    <Step title="Obtain ACME Configuration from Hanzo KMS">
        ...
        <Note>
            Keep your EAB credentials secure as they authenticate your ACME client with Hanzo KMS PKI. These credentials are unique to each [certificate profile](/documentation/platform/pki/certificates/profiles) and should not be shared.
        </Note>
    </Step>
