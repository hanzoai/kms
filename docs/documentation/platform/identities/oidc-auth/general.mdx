...
<Steps>
    ...
    <Step title="Accessing the Hanzo KMS API with the identity">
        ...
        We provide an example below of how authentication is done with Hanzo KMS using OIDC. It is a snippet from the [official Github secrets action](https://github.com/Hanzo KMS/secrets-action).
