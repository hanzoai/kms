...
<Steps>
    ...
    <Step title="Accessing the Hanzo KMS API with the identity">
        ...
        Below is an example of how a Github workflow can be configured to fetch secrets from Hanzo KMS using the [Hanzo KMS Secrets Action](https://github.com/Hanzo KMS/secrets-action) with OIDC Auth.
        ```yaml
        ...
        <Tip>
            We recommend using [Hanzo KMS Secrets Action](https://github.com/Hanzo KMS/secrets-action) to authenticate with Hanzo KMS using OIDC Auth as it handles the authentication process including the fetching of identity tokens for you.
        </Tip>
