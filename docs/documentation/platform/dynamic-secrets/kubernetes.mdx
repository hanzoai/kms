      ...
      <Tab title="Static Credentials">
        ...
        <AccordionGroup>
          <Accordion title="Token (API) Authentication">
            ...
            <Note>
              With Token (API) authentication, Hanzo KMS uses the provided service account token
          ...
          <Accordion title="Gateway Authentication">
            ...
            <Note>
              With Gateway authentication, Hanzo KMS communicates with the Gateway, which then
...
<Note>
  While you can delete the lease from Hanzo KMS, the actual Kubernetes service
