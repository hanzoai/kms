...
description: "Learn the fundamentals of secret referencing and importing in Hanzo KMS."
---

## Secret Referencing

Hanzo KMS's secret referencing functionality makes it possible to reference the value of a "base" secret when defining the value of another secret.
...
Hanzo KMS's Secret Imports functionality makes it possible to import the secrets from another environment or folder into the current folder context.
