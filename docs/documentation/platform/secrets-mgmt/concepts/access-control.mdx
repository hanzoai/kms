...
description: "Learn how access to secrets is controlled in Hanzo KMS."
---

## Secret Hierarchy

Every secret in Hanzo KMS is scoped to an environment and a path.
...
Beyond basic role assignments, Hanzo KMS includes additional access control mechanisms for more advanced use cases:
