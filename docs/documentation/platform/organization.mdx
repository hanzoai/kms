...
If you're using Hanzo KMS Cloud, the ability to create custom roles is available under the **Pro Tier**.

If you're self-hosting Hanzo KMS, then you should contact sales@kms.hanzo.ai to purchase an enterprise license to use it.
