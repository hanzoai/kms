...
description: "Learn what the Model Context Protocol is and how Hanzo KMS helps you manage it securely."
---
...
```mermaid
graph LR
    A[AI Client] --> B[Hanzo KMS MCP Endpoint]
    B --> C[Notion]
    B --> D[GitHub]
    B --> E[Slack]
```
...
4. **Access Control**: Leverage Hanzo KMS's existing access control mechanisms to manage who can use which endpoints.
