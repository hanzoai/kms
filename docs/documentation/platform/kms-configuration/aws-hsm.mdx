...
This guide provides instructions on securing Hanzo KMS project secrets using AWS CloudHSM. 
...
To secure project resources, you will need to add this AWS KMS to your Hanzo KMS organization. To learn how, refer to the documentation [here](./aws-kms).