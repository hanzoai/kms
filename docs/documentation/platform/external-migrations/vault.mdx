...
**After importing:** You'll need to update your Kubernetes deployments to use the [KMS Operator](/integrations/platforms/kubernetes/overview) or [Hanzo KMS SDK](/sdks/overview) instead of the Vault agent/sidecar.
