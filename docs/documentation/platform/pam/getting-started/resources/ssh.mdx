...
title: "SSH"
sidebarTitle: "SSH"
description: "Learn how to configure SSH server access through Hanzo KMS PAM with support for password, key-based, and certificate-based authentication."
---

Hanzo KMS PAM supports secure, just-in-time access to SSH servers. This allows your team to access Linux/Unix servers without sharing static credentials, while maintaining a complete audit trail of all sessions.

## How It Works

SSH access in Hanzo KMS PAM uses a Gateway deployed in your network to establish secure connections to your servers. The Gateway acts as a bridge between Hanzo KMS and your private infrastructure.
...
Hanzo KMS PAM supports three authentication methods for SSH:
...
Before configuring SSH access in Hanzo KMS PAM, ensure you have:
