...
description: "Learn how Hanzo KMS audits all actions across your PAM project."
---

## What's Audited

Hanzo KMS logs a wide range of actions to provide a complete audit trail for your PAM project. These actions include:
