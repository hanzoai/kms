...
description: "Learn how to automatically synchronize your GitHub teams with Hanzo KMS Groups."
---
...
<Steps>
    ...
    <Step title="Approve the Hanzo KMS OAuth application on your organization">
        ...
        3. Grant access to Hanzo KMS oauth application to your configured organization.  Hanzo KMS shown here is an organization, just for walkthrough.
        ![grant-access](../../images/platform/external-syncs/github-org-sync-oauth.png)

        <Info>
          This action only needs to be done once and authorizes the Hanzo KMS OAuth app to read organization details, including team information.
...
<Steps>
    <Step title="Generate a GitHub Access Token">
        ...
        <Tabs>
            <Tab title="Classic Token">
                ...
                3. Give your token a descriptive name (e.g., "Hanzo KMS GitHub Sync")
    ...
    <Step title="Configure the Token in Hanzo KMS">
        1. Navigate to the **Single Sign-On (SSO)** page and select the **Provisioning** tab.
...
<Accordion title="Please check if your organization has approved the Hanzo KMS OAuth application.">
