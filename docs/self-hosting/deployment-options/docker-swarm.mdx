...
The [Docker stack file](https://github.com/hanzoai/kms/tree/main/docker-swarm) used in this guide defines the services and their configurations for deploying Hanzo KMS in a highly available manner. The main components of this stack are as follows.
