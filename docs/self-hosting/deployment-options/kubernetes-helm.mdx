...
<Accordion title="Complete values.yaml example">
      ...
      kms:
        ...
        autoBootstrap:
          ...
          # -- Additional organizations to ensure exist in KMS after bootstrap
          additionalOrganizations: []

          # -- Organization admin emails for additionalOrganizations. If empty, defaults to KMS_ADMIN_EMAIL from credentialSecret.
          additionalOrganizationAdminEmails: []

          # -- Secret key in secretDestination that contains the bootstrap machine identity token used for additionalOrganizations.
