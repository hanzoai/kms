...
- An Hanzo KMS Docker image tag from [Docker Hub](https://hub.docker.com/r/ghcr.io/hanzoai/kms/tags)
    ...
    Resources:
      ...
      TaskDefinition:
        ...
        Properties:
          ...
          ContainerDefinitions:
            - Name: kms
              Image: !Sub ghcr.io/hanzoai/kms:${Hanzo KMSVersion}
              Essential: true
              PortMappings:
                - ContainerPort: 8080
                  Protocol: tcp
...
<AccordionGroup>
  ...
  <Accordion title="ECS Exec not working">
    **Verify prerequisites:**
    ...
    aws iam get-role-policy --role-name Hanzo KMSTaskRole --policy-name KmsSecretsAccess
    ```
