...
Hanzo KMS's [Docker Hub repository](https://hub.docker.com/r/ghcr.io/hanzoai/kms) uses different tagging conventions to indicate which database backend is used:
