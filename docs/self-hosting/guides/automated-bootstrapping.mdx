  ...
  <Tab title="Helm Chart">
    ...
    autoBootstrap:
      ...
      additionalOrganizations:
        ...
        - "Zoo"
        - "Pars"
      # optional; defaults to KMS_ADMIN_EMAIL from credentialSecret when omitted
      additionalOrganizationAdminEmails:
        - "z@hanzo.ai"
      # optional; defaults to "token" and must match the token key in secretTemplate
    ...
    6. **Additional Organization Reconciliation**: Optionally creates any missing organizations listed in `additionalOrganizations` and assigns org-admin access using `additionalOrganizationAdminEmails` (or `KMS_ADMIN_EMAIL` by default)
